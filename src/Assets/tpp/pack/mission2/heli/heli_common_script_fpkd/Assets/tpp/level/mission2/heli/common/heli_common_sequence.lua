...
function this.OnRestoreSVars()
	...
	--r51 Settings
	if TUPPMSettings.player_ENABLE_missionPrepForMoreMissions then
		mvars.heliSpace_SkipMissionPreparetion = {
			[10010] = true, --Prologue - Awakening 
			[10020] = ( not TppStory.IsMissionCleard( 10020 ) ), --Mission 1 - Phantom Limbs 
	--		[10030] = true, --r17 Mission 2 - Flashback Diamond Dogs 
	--		[11043] = true, --r18 Mission 33 - [Subsistence] C2W 
	--		[10240] = true, --r17 Mission 43 - Shining Lights, Even in Death 
			[10280] = true, --Mission 46 - Truth - The Man Who Sold the World 
	--		[11044] = true, --r18 Mission 49 - [Subsistence] Occupation Forces 
	--		[30050] = true, --r17 
	--		[30150] = true, --r17 
	--		[30250] = true, --r17 
			--r17 add all missions here
		}
	end

  --TODO WIP Useless
--  mvars.heliSpace_EquipmentMenu = {
--    [10030] = true, --r17 Mission 2 - Flashback Diamond Dogs 
--    [10240] = true --r17 Mission 43 - Shining Lights, Even in Death 
--  }
	...
	if TUPPMSettings.player_ENABLE_missionPrepForMoreMissions then
		mvars.heliSpace_NoBuddyMenuFromMissionPreparetion = {
			[10020] = true, --Mission 1 - Phantom Limbs 
			[10030] = true, --r17 Mission 2 - Flashback Diamond Dogs 
			[10115] = true, --Mission 22 - Retake the Platform 
			[11043] = true, --r18 Mission 33 - [Subsistence] C2W 
			[10240] = true, --r17 Mission 43 - Shining Lights, Even in Death 
	    [11044] = true, --r18 Mission 49 - [Subsistence] Occupation Forces 
	--		[30050] = true, --r20 Buddy menu allowed for MB for D-Dog at least
	--		[30150] = true, --r17 Hide buddy menu for Zoo
	--		[30250] = true,
			[50050] = true
		}
	end
	...
	if TUPPMSettings.player_ENABLE_missionPrepForMoreMissions then
		mvars.heliSpace_DisableSelectSortieTimeFromMissionPreparetion = {
		 --r18 why not allow time? 
			[10020] = true, --Mission 1 - Phantom Limbs --Always starts in day
			[10030] = true, --r17 Mission 2 - Flashback Diamond Dogs --Always starts in day
	--		[10080] = true, --Mission 13 - Pitch Dark --works
	--    [11043] = true, --r18 Mission 33 - [Subsistence] C2W --works
	    [10240] = true, --r17 Mission 43 - Shining Lights, Even in Death --Always starts in day
	--    [11044] = true, --r18 Mission 49 - [Subsistence] Occupation Forces --works
		}
	end
...
--	this.CommonBuddyHeliSpaceSetting( BuddyType.HORSE, "BuddyHorseLocator" ) --r17
--	this.CommonBuddyHeliSpaceSetting( BuddyType.WALKER_GEAR, "BuddyWalkerGearLocator" )
end
...
function this.OnEndFadeOutSelectLandingPoint()
	...
	--TppPlayer.TUPPMPrint("All missions subsistence")
	--needSkipMissionPraparetion = true --r17 all missions subsistence
...
function this.GetFobTutorialSequenceName()
	...
	if TppMotherBaseManagement.IsBuiltFirstFob() then
		gvars.trm_fobTutorialState = TppTerminal.FOB_TUTORIAL_STATE.FINISH --rX4 set FOB tuts to off
	end
...
sequences.Seq_Game_MissionPreparationTop = {
	...
	OnEnter = function( self )
		...
		--r17
--		TppUiStatusManager.UnsetStatus( "MissionPrep", "DISABLE_SELECT_WEAPONS_ITEMS" )
--		if mvars.heliSpace_EquipmentMenu[nextMissionCode] then
--			TppUiStatusManager.SetStatus( "MissionPrep", "DISABLE_SELECT_WEAPONS_ITEMS" )
--		end
