...
}e=string.format("ly%03d_cl%02d_%05d_heli0000|cl%02dpl%01d_mb_fndt_plnt_heli_%05d|rt_apr_of",a,n,t,n,o-1,t)
else
e=a
end
return e
...
local n={
[1]=true,[30]=true,[50]=true,[55]=true}
...
function e.Messages()
return Tpp.StrCode32Table{Block={
...
if TppMotherBaseManagement.GetMbsClusterBuildStatus{category=TppDefine.CLUSTER_NAME[n]
}=="Building"then
e=e-1
end
return e
