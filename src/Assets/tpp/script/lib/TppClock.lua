...
function e.RegisterClockMessage(id,_seconds)
--	TUPPMLog.Log(
--  "RegisterClockMessage"
--  .."\n id: "..tostring(id)
--  .."\n _seconds: "..tostring(_seconds)
--  ,3)
local r
if(type(_seconds)=="string")then
r=e.ParseTimeString(_seconds,"number")elseif(type(_seconds)=="number")then
r=_seconds
else
return
end
TppCommand.Weather.RegisterClockMessage{id=o(id),seconds=r,isRepeat=true,nil}end
