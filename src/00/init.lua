...
--pcall(Script.LoadLibrary,"/Assets/tpp/script/lib/TUPPMSettings.lua")
--pcall(Script.LoadLibrary,"/Assets/tpp/script/lib/InfInspect.lua")
--pcall(Script.LoadLibrary,"/Assets/tpp/script/lib/TUPPMLog.lua")
--pcall(Script.LoadLibrary,"/Assets/tpp/script/lib/TUPPM.lua")

Script.LoadLibrary("/Assets/tpp/script/lib/TUPPMSettings.lua")
Script.LoadLibrary("/Assets/tpp/script/lib/InfInspect.lua")
Script.LoadLibrary("/Assets/tpp/script/lib/TUPPMLog.lua")
Script.LoadLibrary("/Assets/tpp/script/lib/TUPPMStartup.lua")
