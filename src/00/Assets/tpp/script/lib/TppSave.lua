...
function e.SaveGameData(missionCode,i,S,a,n)
	--TUPPMLog.Log("TppSave.SaveGameData START missionCode"..tostring(missionCode),1)
	if a then
		e.ReserveNextMissionStartSave(e.GetGameSaveFileName(),n)
	else
		local a=e.GetSaveGameDataQueue(missionCode,i,S,n)
		e.EnqueueSave(a)
	end
	e.CheckAndSavePersonalData(a)
	--TUPPMLog.Log("TppSave.SaveGameData END",1)
end
...
function e.CheckAndSavePersonalData(n)
	--TUPPMLog.Log("TppSave.CheckAndSavePersonalData START",1)
	...
	--TUPPMLog.Log("TppSave.CheckAndSavePersonalData END",1)
end
...
function e.VarSave(missionCode,n)
	--TUPPMLog.Log("TppSave.VarSave START missionCode"..tostring(missionCode),1)
	e.SaveVarsToSlot(TppDefine.SAVE_SLOT.GLOBAL,TppScriptVars.GROUP_BIT_ALL,TppScriptVars.CATEGORY_GAME_GLOBAL)
	...
	if e.CanSaveMbMangementData(missionCode)then
	...
	--TUPPMLog.Log("TppSave.VarSave END",1)
end
