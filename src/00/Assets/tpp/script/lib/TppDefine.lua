...
function this.Enum(tableToEnum)
	if type(tableToEnum)~="table"then
		return
	end
	local returnedEnum={}
	for index,value in pairs(tableToEnum)do
		returnedEnum[value]=index-1
	end
	return returnedEnum
end
--r51 Settings
this.SMALL_DIAMOND_GMP=1e4*(TUPPMSettings.res_gmpSmallDiamondMultiplier or 1)
this.LARGE_DIAMOND_GMP=1e5*(TUPPMSettings.res_gmpLargeDiamondMultiplier or 1)
...
this.VARS_GROUP_GAME_DATA_ON_START_MISSION=bitBor(TppScriptVars.GROUP_BIT_GVARS,TppScriptVars.GROUP_BIT_VARS)
...
this.LOCATION_ID={INIT=1,AFGH=10,MAFR=20,CYPR=30,GNTN=40,OMBS=45,MTBS=50,MBQF=55,HLSP=60,FLYK=70,afgh=10,mafr=20,cypr=30,gntn=40,ombs=45,mtbs=50,mbqf=55,hlsp=60,flyk=70,SAND_AFGH=91,SAND_MAFR=92,SAND_MTBS=95,sand_afgh=91,sand_mafr=92,sand_mtbs=95}
...
this.STORY_MISSION_LAYOUT_CODE={
	[10030]=this.OFFLINE_MOHTER_BASE_LAYOUT_CODE, --Mission 2 - Flashback Diamond Dogs
	[10115]=this.OFFLINE_MOHTER_BASE_LAYOUT_CODE, --Mission 22 - Retake the Platform
	[11115]=this.OFFLINE_MOHTER_BASE_LAYOUT_CODE, --???
	[10240]=this.OFFLINE_MOHTER_BASE_LAYOUT_CODE, --Mission 43 - Shining Lights, Even in Death
	[30050]=this.OFFLINE_MOHTER_BASE_LAYOUT_CODE, --MB
	[30051]=this.OFFLINE_MOHTER_BASE_LAYOUT_CODE, --???
	[30150]=500, --Zoo
	[30250]=this.OFFLINE_MOHTER_BASE_LAYOUT_CODE --MBQF
}
...
this.MISSION_COMMON_PACK={AFGH_SCRIPT="/Assets/tpp/pack/location/afgh/pack_common/afgh_script.fpk",
...
this.QUEST_BONUS_GMP={
	[this.QUEST_RANK.S]=3e5*(TUPPMSettings.res_gmpSideOpsMultiplier or 1),
	[this.QUEST_RANK.A]=2e5*(TUPPMSettings.res_gmpSideOpsMultiplier or 1),
	[this.QUEST_RANK.B]=18e4*(TUPPMSettings.res_gmpSideOpsMultiplier or 1),
	[this.QUEST_RANK.C]=14e4*(TUPPMSettings.res_gmpSideOpsMultiplier or 1),
	[this.QUEST_RANK.D]=12e4*(TUPPMSettings.res_gmpSideOpsMultiplier or 1),
	[this.QUEST_RANK.E]=1e5*(TUPPMSettings.res_gmpSideOpsMultiplier or 1),
	[this.QUEST_RANK.F]=9e4*(TUPPMSettings.res_gmpSideOpsMultiplier or 1),
	[this.QUEST_RANK.G]=8e4*(TUPPMSettings.res_gmpSideOpsMultiplier or 1),
	[this.QUEST_RANK.H]=6e4*(TUPPMSettings.res_gmpSideOpsMultiplier or 1),
	[this.QUEST_RANK.I]=3e4*(TUPPMSettings.res_gmpSideOpsMultiplier or 1)
}
...
this.QUIET_REUNION_MISSION_COUNT=6
this.WEAPONSLOT={
	MIN=0,
	PRIMARY_HIP=0,
	PRIMARY_BACK=1,
