...
local o={[FobMode.MODE_ACTUAL]="MODE_ACTUAL",[FobMode.MODE_SHAM]="MODE_SHAM",[FobMode.MODE_VISIT]="MODE_VISIT",[FobMode.MODE_NONE]="MODE_NONE"}e(a,"vars.fobSneakMode = "..tostring(o[vars.fobSneakMode]))
...
local e={}u(e,TppDbgStr32.DEBUG_strCode32List)
...
local n=""if e.animalBlockScript.OnMessage then
n="exist"else
n="  not"end
