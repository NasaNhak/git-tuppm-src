mbdvc_map_mission_parameter = {
    ...
    GetMissionParameter = function( missionId )
      ...
      if missionId == 0 then
        return {}
      elseif missionId == 10010 then --Prologue - Awakening
        return {
          missionArea2 = {
          },
          safetyArea2 = {
      ...
      elseif missionId == 10020 then --Mission 1 - Phantom Limbs
        return {
          missionArea2 = {
      ...
      elseif missionId == 10030 then --Mission 2 - Flashback Diamond Dogs
        return {
          missionArea2 = {
          },
          safetyArea2 = {
      ...
      elseif missionId == 10033 then --r18 ?
        return {
          missionArea2 = {
      ...
      elseif missionId == 10036 then --Mission 3 - A Heroes Way
        return {
          missionArea2 = {
          ...
          heliLandPoint = {
            {point=Vector3(418.33,278.22,2261.37),startPoint=Vector3(887.95,309.12,2383.44),routeId="lz_drp_field_I0000|rt_drp_field_I_0000"},--D
            {point=Vector3(802.56,345.37,1637.75),startPoint=Vector3(1247.97,345.37,1298.36),routeId="lz_drp_field_N0000|rt_drp_field_N_0000"},--D
            {point=Vector3(-359.62,283.42,1714.79),startPoint=Vector3(-771.13,305.42,1447.29),routeId="lz_drp_field_W0000|rt_drp_field_W_0000"},},--D
        }
      elseif missionId == 10040 then -- Mission 6 - Where Do the Bees Sleep
        return {
          missionArea2 = {
          ...
          heliLandPoint = {
            {point=Vector3(2106.16,463.64,-1747.21),startPoint=Vector3(2043.26,474.64,-1248.49),routeId="lz_drp_fort_I0000|rt_drp_fort_I_0000"},--D
            {point=Vector3(1187.73,320.98,-10.40),startPoint=Vector3(1489.55,336.98,65.91),routeId="lz_drp_slopedTownEast_E0000|rt_drp_slopedTownEast_E_0000"},},--D
        }
      elseif missionId == 10041 then --Mission 7 - Red Brass 
        return {
          missionArea2 = {
          ...
          heliLandPoint = {
            {point=Vector3(-289.80,346.69,269.68),startPoint=Vector3(161.28,335.69,140.48),routeId="lz_drp_enemyBase_N0000|rt_drp_enemyBase_N_0000"},--D
            {point=Vector3(802.56,345.37,1637.75),startPoint=Vector3(1247.97,345.37,1298.36),routeId="lz_drp_field_N0000|rt_drp_field_N_0000"},--D
            {point=Vector3(-359.62,283.42,1714.79),startPoint=Vector3(-771.13,305.42,1447.29),routeId="lz_drp_field_W0000|rt_drp_field_W_0000"},--D
            {point=Vector3(822.37,360.44,292.44),startPoint=Vector3(335.25,364.44,413.83),routeId="lz_drp_slopedTown_E0000|rt_drp_slopedTown_E_0000"},--D
            {point=Vector3(512.11,316.60,167.44),startPoint=Vector3(1074.92,379.60,506.01),routeId="lz_drp_slopedTown_I0000|rt_drp_slopedTown_I_0000"},--D
            {point=Vector3(1275.22,337.42,1313.33),startPoint=Vector3(1255.64,340.42,1747.07),routeId="lz_drp_ruinsNorth_S0000|rt_drp_ruinsNorth_S_0000"},--D
            {point=Vector3(-351.61,321.89,768.34),startPoint=Vector3(-91.82,331.89,918.56),routeId="lz_drp_enemyBase_S0000|rt_drp_enemyBase_S_0000"},--D
            {point=Vector3(418.33,278.22,2261.37),startPoint=Vector3(887.95,309.12,2383.44),routeId="lz_drp_field_I0000|rt_drp_field_I_0000"},--D
            {point=Vector3(-596.89,353.02,497.40),startPoint=Vector3(-946.28,309.02,981.35),routeId="lz_drp_enemyBase_I0000|rt_drp_enemyBase_I_0000"},},--D
        }
      elseif missionId == 10043 then -- Mission 4 - C2W 
        return {
          missionArea2 = {
          ...
          heliLandPoint = {
            {point=Vector3(1275.22,337.42,1313.33),startPoint=Vector3(1255.64,340.42,1747.07),routeId="lz_drp_ruinsNorth_S0000|rt_drp_ruinsNorth_S_0000"},--d
            {point=Vector3(1444.40,364.14,390.78),startPoint=Vector3(925.92,368.14,502.51),routeId="lz_drp_commFacility_I0000|rt_drp_commFacility_I_0000"},},--d
        }
      elseif missionId == 10044 then --Mission 8 - Occupation Forces 
        return {
          missionArea2 = {
      ...
      elseif missionId == 10045 then --10045 : Mission 32 - To Know Too Much 
        return {
          missionArea2 = {
