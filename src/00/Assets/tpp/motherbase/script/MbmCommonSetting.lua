...
--rX44 Only SPP
--,g=(.*),f=(.*),e=(.*),d=(.*),c=(.*),b=(.*),a=(.*),s=(.*),sp=(.*),spp=(.*)\}
--,g=0,f=0,e=0,d=0,c=0,b=0,a=0,s=0,sp=0,spp=100}
...
--r51 Settings
if TUPPMSettings.game_ENABLE_highRankingSoldiersInTheField then
	TppMotherBaseManagement.RegisterStaffBaseRankRange{totalSectionLv=315,g=0,f=0,e=3,d=10,c=15,b=37,a=30,s=5,sp=5,spp=0} --r28 Start here
	TppMotherBaseManagement.RegisterStaffBaseRankRange{totalSectionLv=322,g=0,f=0,e=3,d=5,c=15,b=37,a=35,s=5,sp=5,spp=0}
	TppMotherBaseManagement.RegisterStaffBaseRankRange{totalSectionLv=329,g=0,f=0,e=3,d=5,c=15,b=37,a=35,s=5,sp=5,spp=0}
	TppMotherBaseManagement.RegisterStaffBaseRankRange{totalSectionLv=336,g=0,f=0,e=3,d=5,c=15,b=37,a=35,s=5,sp=5,spp=0}
	TppMotherBaseManagement.RegisterStaffBaseRankRange{totalSectionLv=343,g=0,f=0,e=3,d=5,c=10,b=37,a=35,s=10,sp=10,spp=0}
	TppMotherBaseManagement.RegisterStaffBaseRankRange{totalSectionLv=350,g=0,f=0,e=3,d=5,c=11,b=36,a=35,s=10,sp=10,spp=5}
	TppMotherBaseManagement.RegisterStaffBaseRankRange{totalSectionLv=357,g=0,f=0,e=3,d=5,c=11,b=36,a=35,s=10,sp=10,spp=5}
	TppMotherBaseManagement.RegisterStaffBaseRankRange{totalSectionLv=364,g=0,f=0,e=3,d=5,c=11,b=36,a=35,s=10,sp=10,spp=5}
	TppMotherBaseManagement.RegisterStaffBaseRankRange{totalSectionLv=371,g=0,f=0,e=3,d=6,c=11,b=35,a=35,s=10,sp=12,spp=5}
	TppMotherBaseManagement.RegisterStaffBaseRankRange{totalSectionLv=378,g=0,f=0,e=3,d=6,c=11,b=35,a=35,s=10,sp=14,spp=10}
	TppMotherBaseManagement.RegisterStaffBaseRankRange{totalSectionLv=385,g=0,f=0,e=3,d=5,c=11,b=31,a=35,s=15,sp=16,spp=10}
	TppMotherBaseManagement.RegisterStaffBaseRankRange{totalSectionLv=392,g=0,f=0,e=3,d=5,c=11,b=31,a=35,s=15,sp=18,spp=10}
	TppMotherBaseManagement.RegisterStaffBaseRankRange{totalSectionLv=399,g=0,f=0,e=3,d=6,c=11,b=30,a=35,s=15,sp=20,spp=10}
	TppMotherBaseManagement.RegisterStaffBaseRankRange{totalSectionLv=406,g=0,f=0,e=3,d=6,c=11,b=30,a=35,s=15,sp=22,spp=10}
	TppMotherBaseManagement.RegisterStaffBaseRankRange{totalSectionLv=413,g=0,f=0,e=3,d=6,c=11,b=25,a=35,s=20,sp=24,spp=10}
	TppMotherBaseManagement.RegisterStaffBaseRankRange{totalSectionLv=420,g=0,f=0,e=3,d=6,c=11,b=25,a=35,s=20,sp=26,spp=10}
	TppMotherBaseManagement.RegisterStaffBaseRankRange{totalSectionLv=427,g=0,f=0,e=3,d=6,c=11,b=25,a=35,s=20,sp=28,spp=10}
	TppMotherBaseManagement.RegisterStaffBaseRankRange{totalSectionLv=434,g=0,f=0,e=3,d=6,c=11,b=20,a=35,s=25,sp=30,spp=10}
	TppMotherBaseManagement.RegisterStaffBaseRankRange{totalSectionLv=441,g=0,f=0,e=3,d=6,c=11,b=15,a=35,s=30,sp=32,spp=12}
	TppMotherBaseManagement.RegisterStaffBaseRankRange{totalSectionLv=448,g=0,f=0,e=3,d=6,c=11,b=15,a=35,s=30,sp=34,spp=14}
	TppMotherBaseManagement.RegisterStaffBaseRankRange{totalSectionLv=455,g=0,f=0,e=3,d=6,c=11,b=15,a=35,s=30,sp=36,spp=16}
	TppMotherBaseManagement.RegisterStaffBaseRankRange{totalSectionLv=518,g=0,f=0,e=3,d=6,c=11,b=15,a=35,s=30,sp=38,spp=18}
	TppMotherBaseManagement.RegisterStaffBaseRankRange{totalSectionLv=574,g=0,f=0,e=3,d=6,c=11,b=15,a=35,s=30,sp=40,spp=20}
	TppMotherBaseManagement.RegisterStaffBaseRankRange{totalSectionLv=630,g=0,f=0,e=3,d=6,c=11,b=15,a=35,s=30,sp=42,spp=22}
	TppMotherBaseManagement.RegisterStaffBaseRankRange{totalSectionLv=686,g=0,f=0,e=3,d=6,c=11,b=15,a=35,s=30,sp=44,spp=24}
	TppMotherBaseManagement.RegisterStaffBaseRankRange{totalSectionLv=728,g=0,f=0,e=0,d=2,c=5,b=13,a=40,s=40,sp=46,spp=26}
	TppMotherBaseManagement.RegisterStaffBaseRankRange{totalSectionLv=756,g=0,f=0,e=0,d=0,c=3,b=13,a=39,s=45,sp=48,spp=28}
	TppMotherBaseManagement.RegisterStaffBaseRankRange{totalSectionLv=784,g=0,f=0,e=0,d=0,c=3,b=13,a=34,s=50,sp=50,spp=30}
	TppMotherBaseManagement.RegisterStaffBaseRankRange{totalSectionLv=812,g=0,f=0,e=0,d=0,c=3,b=13,a=29,s=55,sp=52,spp=32}
	TppMotherBaseManagement.RegisterStaffBaseRankRange{totalSectionLv=840,g=0,f=0,e=0,d=0,c=3,b=10,a=27,s=60,sp=54,spp=34}
	TppMotherBaseManagement.RegisterStaffBaseRankRange{totalSectionLv=868,g=0,f=0,e=0,d=0,c=3,b=10,a=22,s=65,sp=56,spp=36}
	TppMotherBaseManagement.RegisterStaffBaseRankRange{totalSectionLv=882,g=0,f=0,e=0,d=0,c=3,b=10,a=17,s=70,sp=58,spp=38}
	TppMotherBaseManagement.RegisterStaffBaseRankRange{totalSectionLv=910,g=0,f=0,e=0,d=0,c=3,b=6,a=16,s=75,sp=60,spp=40} --sp=30%, spp=20%
	TppMotherBaseManagement.RegisterStaffBaseRankRange{totalSectionLv=1050,g=0,f=0,e=0,d=0,c=0,b=3,a=17,s=80,sp=500,spp=400} --r32 sp=50%, spp=40% --r28 increased high rank soldiers
else
...
--r51 Settings
local mbSup_enemySoldierEnmityMultiplier=math.max(TUPPMSettings.mbSup_enemySoldierEnmityMultiplier or 1,0)

TppMotherBaseManagement.RegisterTimeMinutePer1Enmity{index=0,heroicPoint=0,timeMinutePer1Enmity=10*mbSup_enemySoldierEnmityMultiplier} --r28 Start here
TppMotherBaseManagement.RegisterTimeMinutePer1Enmity{index=1,heroicPoint=1e3,timeMinutePer1Enmity=10*mbSup_enemySoldierEnmityMultiplier}
TppMotherBaseManagement.RegisterTimeMinutePer1Enmity{index=2,heroicPoint=2e3,timeMinutePer1Enmity=10*mbSup_enemySoldierEnmityMultiplier}
TppMotherBaseManagement.RegisterTimeMinutePer1Enmity{index=3,heroicPoint=3e3,timeMinutePer1Enmity=10*mbSup_enemySoldierEnmityMultiplier}
TppMotherBaseManagement.RegisterTimeMinutePer1Enmity{index=4,heroicPoint=4e3,timeMinutePer1Enmity=10*mbSup_enemySoldierEnmityMultiplier}
TppMotherBaseManagement.RegisterTimeMinutePer1Enmity{index=5,heroicPoint=5e3,timeMinutePer1Enmity=10*mbSup_enemySoldierEnmityMultiplier}
TppMotherBaseManagement.RegisterTimeMinutePer1Enmity{index=6,heroicPoint=6e3,timeMinutePer1Enmity=10*mbSup_enemySoldierEnmityMultiplier}
TppMotherBaseManagement.RegisterTimeMinutePer1Enmity{index=7,heroicPoint=7e3,timeMinutePer1Enmity=10*mbSup_enemySoldierEnmityMultiplier}
TppMotherBaseManagement.RegisterTimeMinutePer1Enmity{index=8,heroicPoint=8e3,timeMinutePer1Enmity=10*mbSup_enemySoldierEnmityMultiplier}
TppMotherBaseManagement.RegisterTimeMinutePer1Enmity{index=9,heroicPoint=9e3,timeMinutePer1Enmity=10*mbSup_enemySoldierEnmityMultiplier}
TppMotherBaseManagement.RegisterTimeMinutePer1Enmity{index=10,heroicPoint=1e4,timeMinutePer1Enmity=10*mbSup_enemySoldierEnmityMultiplier}
